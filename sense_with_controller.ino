...
// variables and definitions
      ...
      //Important parameter, set to match environment
          ...
          #define MaxTemp 23 // [degC] maximum allowed temperature, over which cooler is turned on (needed for rescaling inputs)
...
// A PID control tuning is the method of adjusting the value of Kp, Kd, Ki so s to follow.


      //control parameters - editing not recommended     
          double K_P_ctrl = 200; //proportional gain 
          double K_I_ctrl = 0.01; //integral gain (set to lower values i.e. 10^-3) 0.2
          double K_D_ctrl = 10; //derivative gain 
